                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('menus.update', $menu->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-area id="description" class="block mt-1 w-full" name="description">{{ old('description', $menu->description) }}</x-text-area>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="category" name="category" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="starter" {{ old('category', $menu->category) == 'starter' ? 'selected' : '' }}>Starter</option>
                                <option value="main" {{ old('category', $menu->category) == 'main' ? 'selected' : '' }}>Main</option>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="image_path" class="block mt-1 w-full" type="text" name="image_path" :value="old('image_path', $menu->image_path)" />
