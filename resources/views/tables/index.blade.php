            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium text-gray-900">Restaurant Tables</h3>
                    ...
                    @if ($tables->isEmpty())
                        <p>No tables found. Please add some.</p>
                    @else
                                    ...
                                    @foreach ($tables as $table)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('tables.edit', $table->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form action="{{ route('tables.destroy', $table->id) }}" method="POST" class="inline-block ml-4">
                                                    @csrf
                                                    @method('DELETE')
